...
class RelationConstructorByRelations(ABC):
    ...
    @staticmethod
    def from_dict(obj: Any, interpreter: Interpreter) -> Optional['RelationConstructorByRelations']:
        if obj is None:
            return None
...
class EntityConstructorByRelation(ABC):
    ...
    @staticmethod
    def from_dict(obj: Any, interpreter: Interpreter = Interpreter) -> Optional['EntityConstructorByRelation']:
        if obj is None:
            return None
